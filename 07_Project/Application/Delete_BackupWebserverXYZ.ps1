...
$VaultName = "BackupWebserverXYZ" #fetch automatically
$Subscription = "Suheri Koes" #fetch automatically
$ResourceGroup = "XYZ_RG" #fetch automatically
$SubscriptionId = "1168811b-be55-443f-ad5d-bd1676feeb9e" #fetch automatically
