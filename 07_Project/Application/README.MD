...
Met de wijzigingen van v1.1 wordt zijn dit de gemaakte dependacies en deploy-volgorde:
...
- 1 statisch publiek IP voor toegang tot de website via de Application Gateway
